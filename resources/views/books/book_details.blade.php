            ...
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-12 col-sm-6">
                        ...
                        <p>
                        <rating :book="{{ json_encode($book) }}" :star_size="{{ json_encode(30)}}"></rating>
                        </p>
                ...
                <div class="row mt-4">
                    <nav class="w-100">
                        <div class="nav nav-tabs" id="product-tab" role="tablist">
                            ...
                            <a class="nav-item nav-link" id="comment-tab" data-toggle="tab" href="#comment" role="tab" aria-controls="comment" aria-selected="false">Đánh giá</a>
                        </div>
                    </nav>
                    <div class="tab-content p-3" id="nav-tabContent">
                        ...
                        <div class="tab-pane fade" id="comment" role="tabpanel" aria-labelledby="product-rating-tab">
                            <admin-comments :book="{{ json_encode($book) }}"></admin-comments>
                        </div>
                    </div>
                </div>
            </div>
