...
<h1>Đơn hàng đã giao(Đã hoàn thành)</h1>
@stop
    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">Danh sách đơn hàng đã giao -- </h3>
                @if (!isset($search))
                <h4 class="card-title">
                ...
                <div class="card-tools">
                    <form action="{{ route('delivered_orders') }}" method="get">
                        @csrf
                        ...
                        <tr>
                            ...
                            <td class="table__content">
                                <form action="{{route('receive_order',['order' => $order])}}" method="post">
                                    @method('PUT')
                                    @csrf
                                    <button class="btn-flat btn-secondary btn-sm" type='submit'>Giao hàng lại</button>
                                </form>
                            </td>
                            <td class="table__content">
